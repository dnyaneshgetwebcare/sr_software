...
$form = ActiveForm::begin(['id' => 'payment_report', 'method' => 'post', 'action' => ['payment-report/payment-report'],
...
<div class="row page-header no-status-page-header">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="text-align: center;"><h4><b><?php echo $this->title; ?></b>
      </h4></div>
  </div>
</div>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
          ...
          <div class="form-group cust-group">
            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label" id="date_lbl"> Payment From </label>
            <span class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
        <?php
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 report-submit">
          <button type="button" onclick="submitForm()" class="btn btn-primary" data-toggle="tooltip"
    ...
    <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="billing_type">
                           <div class="form-group cust-group">
        <label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label"> Mode of Payment </label>
        <span class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
          <?php
                echo $form->field($model, 'search_mode')->widget(Select2::classname(), [
                'data' => [''=>'Select', 'Cash' => 'Cash', 'Google Pay' => 'Google Pay', 'Phone Pe' => 'Phone Pe', 'Bank Transfer' => 'Bank Transfer', 'Paytm' => 'Paytm', 'Other' => 'Other'],
                'options' => ['prompt' => $label_select.' Customer ','class'=>'form-control txt', 'multiple' => true,],
                'pluginOptions' => [
                'allowClear' => false
                ],
            ])->label(false);?>
