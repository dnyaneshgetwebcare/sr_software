    ...
    $gridColumns = [
      ...
      [
            ...
            [
              ...
              'headerOptions' => ['style' => 'width:10%'],
             // 'label' => 'Type of Payment',
              'filter'=>Html::activeDropDownList($searchModel, 'received_by',([''=>'Select', 'Varsha' => 'Varsha', 'Others' => 'Others', ]),['class'=>'form-control']),
            ...
            [
              ...
              'headerOptions' => ['style' => 'width:5%'],
              //'label' => 'Type of Payment',
              'filter'=>Html::activeDropDownList($searchModel, 'sendto',([''=>'Select', 'Company' => 'Company',  'Varsha' => 'Varsha', ]),['class'=>'form-control']),
               ...
               /* 'pager' => [ // Scroll Grid
                ...
                'panel' =>
                    [
                        ...
                        'before'=>'<div class="pull-left report-back-btn-ar" style="margin-left:20px;"> </div><div style="text-align: center;font-size:16px;"><center><b>'. $this->title .'</center></b></div>',   // <img src="img/icons/back-arrow.png" style="height:16px;cursor:pointer;" id="back_button" class="back-redirect-for-button">
                    ],
                'persistResize' => false,
