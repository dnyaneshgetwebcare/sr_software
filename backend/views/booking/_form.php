                    ...
                    <div class="tab-content">
                      ...
                      <div class="even-strip row_new" style="border-top:1px solid #eee;">
                        <div class="form-group row" >
                          <label class="col-md-6 control-label"
                                 style="align-self: center;margin:0; padding: 10px"> Sub-Total(Rent) </label>
                          <div class="col-md-6 number" style="align-content: center; text-align: end;    padding-right: 30px;">
                     ...
                     <div class="even-strip row_new" style="border-top:1px solid #eee;">
                      ...
                      <div class="even-strip row_new" style="border-top:1px solid #eee;">
                        <div class="form-group row">
                          <label class="col-md-6 control-label"
                                 style="align-self: center;margin:0; padding: 10px"> Rent Amount </label>
                          <div class="col-md-6 number" style="align-content: center; text-align: end;    padding-right: 30px;">
