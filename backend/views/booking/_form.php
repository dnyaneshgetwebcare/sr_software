  ...
  */
  ...
  function addText(id, selection_obj = '') {
    ...
    if (selection_obj == '') {
      ...
      var imgsrc = selection_obj.img_url;
    }
    if (product_id == '') {
  ...
  function setitemsbilling() {
    $('.menu_item-checkbox:checked').each(function () {
      ...
      let bookingitem_id = `bookingitem-${count_item-1}-product_id`;
      console.log('Elements',`#${bookingitem_id}`);
      console.log('Elements value',$(`#${bookingitem_id}`).val());
      if ($(`#${bookingitem_id}`) == undefined || $(`#${bookingitem_id}`).val() != '') {
        $('#add_billing_item').click();
        bookingitem_id = `bookingitem-${count_item-1}-product_id`;
        console.log('New Elements',`#${bookingitem_id}`);
      }
