            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row">
                        <div class="round round-lg align-self-center round-info"><i class="mdi mdi-cellphone-link"></i>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <?= GridView::widget([
                            ...
                            'tableOptions' => ['id' => 'example', 'class' => 'display nowrap table table-hover table-striped ', 'style' => 'height:200px;'],
                            'columns' => [
