...
/* @var $searchModel backend\models\ColorMasterSearch */
...
<script type="application/javascript">
    function addnewItem() {
        $.ajax({
            url:"<?php echo \Yii::$app->getUrlManager()->createUrl('color-master/create') ?>",
            type: 'post',
            dataType:'html',
            beforeSend: function(){
                $(".overlay").show();
    ...
    function open_update(type_id) {
        $.ajax({
            url:"<?php echo \Yii::$app->getUrlManager()->createUrl('color-master/update') ?>",
            type: 'get',
            data:{
                id:type_id
               },
