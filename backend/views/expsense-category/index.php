...
/* @var $searchModel backend\models\ExpsenseCategorySearch */
...
<div class="expsense-category-index">
...
<script type="application/javascript">
    function addnewItem() {
        ...
        $.ajax({
            url:"<?php echo \Yii::$app->getUrlManager()->createUrl('expsense-category/create') ?>",
            type: 'post',
            dataType:'html',
            beforeSend: function(){
                $(".overlay").show();
        ...
        $.ajax({
            url:"<?php echo \Yii::$app->getUrlManager()->createUrl('expsense-category/update') ?>",
            type: 'get',
            data:{
                id:type_id
               },
