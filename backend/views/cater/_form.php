...
<div class="row" >
    ...
    <?php $form = ActiveForm::begin(['enableClientValidation'=>false,'id'=>'category-form','layout' => 'horizontal', 'fieldConfig' => [
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.modal-header').html("<span style='color:#3a3636;font-size:14px'><b>Category</b><button type='button' class='close' data-dismiss='modal' aria-hidden='true'>×</button></span>");
