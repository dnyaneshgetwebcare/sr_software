...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.modal-header').html("<span style='color:#3a3636;font-size:14px'><b>Address Group</b><button type='button' class='close' data-dismiss='modal' aria-hidden='true'>×</button></span>");
